...
pub(crate) static TASK_SIGNAL_BUS: Lazy<RwLock<HashMap<String, TaskSignal>>> = Lazy::new(|| RwLock::new(HashMap::new()));
/// Task Step signal bus: task_id -> (step_index -> Signal)
pub(crate) static TASK_STEP_SIGNAL_BUS: Lazy<RwLock<HashMap<String, HashMap<usize, DriverSignal>>>> = Lazy::new(|| RwLock::new(HashMap::new()));
