...
//! - `OsRebootSkill`: Reboot the system
//! - `OsShutdownSkill`: Shutdown the system
//! - `OsSleepSkill`: Put the system to sleep/hibernate
...
//! - `OsNetworkInfoSkill`: Get network interface information
...
#[derive(Debug)]
pub struct OsRebootSkill;

#[async_trait::async_trait]
impl Skill for OsRebootSkill {
    fn name(&self) -> &str {
        "os_reboot"
    }
...
#[derive(Debug)]
pub struct OsShutdownSkill;

#[async_trait::async_trait]
impl Skill for OsShutdownSkill {
    fn name(&self) -> &str {
        "os_shutdown"
    }
...
#[derive(Debug)]
pub struct OsSleepSkill;

#[async_trait::async_trait]
impl Skill for OsSleepSkill {
    fn name(&self) -> &str {
        "os_sleep"
    }
...
#[derive(Debug)]
pub struct OsLockSkill;

#[async_trait::async_trait]
impl Skill for OsLockSkill {
    fn name(&self) -> &str {
        "os_lock"
    }
...
#[derive(Debug)]
pub struct OsLogoutSkill;

#[async_trait::async_trait]
impl Skill for OsLogoutSkill {
    fn name(&self) -> &str {
        "os_logout"
    }
...
#[derive(Debug)]
pub struct OsHibernateSkill;

#[async_trait::async_trait]
impl Skill for OsHibernateSkill {
    fn name(&self) -> &str {
        "os_hibernate"
    }
...
#[derive(Debug)]
pub struct OsGetUptimeSkill;

#[async_trait::async_trait]
impl Skill for OsGetUptimeSkill {
    fn name(&self) -> &str {
        "os_get_uptime"
    }
...
#[derive(Debug)]
pub struct OsGetLoadAverageSkill;

#[async_trait::async_trait]
impl Skill for OsGetLoadAverageSkill {
    fn name(&self) -> &str {
        "os_get_load_average"
    }
...
#[derive(Debug)]
pub struct OsGetHostnameSkill;

#[async_trait::async_trait]
impl Skill for OsGetHostnameSkill {
    fn name(&self) -> &str {
        "os_get_hostname"
    }
...
#[derive(Debug)]
pub struct OsGetUserSkill;

#[async_trait::async_trait]
impl Skill for OsGetUserSkill {
    fn name(&self) -> &str {
        "os_get_user"
    }
...
#[derive(Debug)]
pub struct OsDiskUsageSkill;

#[async_trait::async_trait]
impl Skill for OsDiskUsageSkill {
    fn name(&self) -> &str {
        "os_disk_usage"
    }
...
#[derive(Debug)]
pub struct OsMemoryInfoSkill;

#[async_trait::async_trait]
impl Skill for OsMemoryInfoSkill {
    fn name(&self) -> &str {
        "os_memory_info"
    }
...
#[derive(Debug)]
pub struct OsCpuInfoSkill;

#[async_trait::async_trait]
impl Skill for OsCpuInfoSkill {
    fn name(&self) -> &str {
        "os_cpu_info"
    }
...
#[derive(Debug)]
pub struct OsNetworkInfoSkill;

#[async_trait::async_trait]
impl Skill for OsNetworkInfoSkill {
    fn name(&self) -> &str {
        "os_network_info"
    }
...
#[derive(Debug)]
pub struct OsBatteryInfoSkill;

#[async_trait::async_trait]
impl Skill for OsBatteryInfoSkill {
    fn name(&self) -> &str {
        "os_battery_info"
    }
...
#[derive(Debug)]
pub struct OsNotificationSkill;

#[async_trait::async_trait]
impl Skill for OsNotificationSkill {
    fn name(&self) -> &str {
        "os_notification"
    }
