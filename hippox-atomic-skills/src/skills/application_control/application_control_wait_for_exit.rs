// application_control/application_control_wait_for_exit.rs
...
#[derive(Debug)]
pub struct ApplicationControlWaitForExitSkill;

#[async_trait::async_trait]
impl Skill for ApplicationControlWaitForExitSkill {
    fn name(&self) -> &str {
