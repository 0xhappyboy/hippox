...
use crate::skills::BitcoinWalletSkill;
#[cfg(any(feature = "blockchain", feature = "all"))]
use crate::skills::EvmWalletSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserBackSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserClickSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserCloseSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserExecuteJsSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserFindElementSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserForwardSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserGetTextSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserGetTitleSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserGetUrlSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserNavigateSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserRefreshSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserScreenshotSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserScrollSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserTabCloseSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserTabNewSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserTabSwitchSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserTypeSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::HaveHeadBrowserWaitSkill;
#[cfg(any(feature = "blockchain", feature = "all"))]
use crate::skills::SolanaWalletSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
use crate::skills::have_head_browser::HaveHeadBrowserElementExistsSkill;
#[cfg(any(feature = "have_head_browser", feature = "all"))]
...
static SKILL_REGISTRY: Lazy<RwLock<HashMap<String, Arc<dyn Skill>>>> = Lazy::new(|| {
    ...
    registry.insert(
        ...
        Arc::new(crate::skills::ExecCommandSkill) as Arc<dyn Skill>,
    );
    // ==================== Document Skills ====================
